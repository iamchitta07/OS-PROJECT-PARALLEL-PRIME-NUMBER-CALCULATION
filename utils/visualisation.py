...
def plot_graph(x_values: list[int], y_values: list[float], lower_bound: int, upper_bound: int, index: int, user_name: str):
    ...
    plt.title(f"Visualization of Cores Vs. Time,\nCalculation of Prime Numbers in the Range [{lower_bound}, {upper_bound}],\nIn {user_name}'s System")
    ...
    # 7. Save and display
    plt.savefig(f"./outputs/{user_name}_line_chart.png")